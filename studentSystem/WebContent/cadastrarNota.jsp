...
<div class="container">
	<form action="cadastrarNota" method="post">
		<div class="form-group">
		    ...
		    <input type="text" class="form-control" name="idCourse" placeholder="Ex.: 5">
		    <small id="idCourse" class="form-text text-muted">Digite o <b>ID da matéria</b> em que a avaliação irá ser cadastrada.</small>
		</div>
		<div class="form-group">
		    <label for="name">Avaliação:</label>
		    <input type="text" class="form-control" name="name" placeholder="Ex.: Prova final">
		    <small id="name" class="form-text text-muted">Digite o nome da avaliação a ser cadastrada uma nota.</small>
		</div>
		<div class="form-group">
		    <label for="name">Nota:</label>
		    <input type="text" class="form-control" name="grade"  placeholder="Ex.: 7"
		    onkeypress="return event.charCode >= 48 && event.charCode <= 57">
		    <small id="grade" class="form-text text-muted">Digite a nota da avaliação a ser cadastrada uma nota.</small>
		</div>
		<div class="form-group">
	  ...
	  <button type="submit" name="save" class="btn btn-primary">Cadastrar Nota</button>
	</form>
</div>
